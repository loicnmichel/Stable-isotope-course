...
(ggplot(DipOdo, aes(x=iso1, y=iso2))+
   ...
   geom_path(data=Ellipse_Dip_Eleph,aes(x=V1, y=V2),colour="#377EB8",linewidth=1.25, linetype="dashed")+
   geom_path(data=Ellipse_Dip_Lions,aes(x=V1, y=V2),colour="#E41A1C",linewidth=1.25, linetype="dashed")+
   geom_path(data=Ellipse_Odo_Eleph,aes(x=V1, y=V2),colour="#377EB8",linewidth=1.25, linetype="solid")+
   geom_path(data=Ellipse_Odo_Lions,aes(x=V1, y=V2),colour="#E41A1C",linewidth=1.25, linetype="solid")+
